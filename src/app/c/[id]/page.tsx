          ...
          {projects.length === 0 ? (
            ...
            projects.map((proj) => (
              <a 
                ...
                className="block bg-[#0a0c10] border border-gray-800 rounded-2xl p-5 sm:p-6 hover:border-accent-blue/50 hover:bg-[#0f1117] transition-all group shadow-sm shadow-black/20"
              >
